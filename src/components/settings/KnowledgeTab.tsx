/**
 * 知识库 tab of the settings hub (was its own KnowledgePanel overlay).
 *
 * Read-only over IPC by design: chunking, embedding and persistence all live
 * in the main process; this tab only previews retrieval, edits notes and binds
 * a pre-chunked knowledge base. The panel chrome (title + close ✕) now comes
 * from the hub's OverlayShell, so this component returns a bare fragment.
 */
