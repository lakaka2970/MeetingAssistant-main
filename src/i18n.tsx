...
const zh = {
  ...
  answer: {
    ...
    resumeSetTitle: (name: string, chars: number) =>
      `简历：${name}（${chars}字）点击更换（.md/.txt/.docx/.pdf/.pptx）`,
    resumeEmptyTitle: '导入我的简历（.md/.txt/.docx/.pdf/.pptx）',
    resumeRemoveTitle: '移除简历',
    jd: 'JD',
    jdSetTitle: (name: string, chars: number) =>
      `岗位JD：${name}（${chars}字）点击更换（.md/.txt/.docx/.pdf/.pptx）`,
    jdEmptyTitle: '导入岗位JD（.md/.txt/.docx/.pdf/.pptx）',
    jdRemoveTitle: '移除岗位JD',
    clear: '清空',
    clearTitle: '清空本会话对话',
    empty: '点转录里对方那句的「⚡答」让 AI 帮你回答；或在下方随便问。答案会在这里逐条累积。',
    emptyKbHint: '\n\n提示：点上方「📄简历」「📋JD」导入资料（支持 docx/pdf/pptx），回答会更贴合你。',
    stop: '停',
    copy: '复制',
    copyTitle: '复制',
  ...
  knowledge: {
    ...
    importItemReason: {
      ...
      'too-large': '文件超过 50 MB，未读取',
    },
    importItemChunks: (n: number) => `${n} 个语块`,
    importItemSummaries: (n: number) => `节摘要 ${n} 条`,
    modelLabel: '嵌入模型',
    modelLocal: '已缓存（离线可用）',
  ...
  settings: {
    ...
    otherSection: '其他',
    otherHint:
      '麦克风开关与多模态切换在标题栏；简历/岗位JD 在提词卡「📄简历」「📋JD」按会话导入（支持 docx/pdf/pptx）。',
...
const en: Dict = {
  ...
  answer: {
    ...
    resume: 'Resume',
    resumeSetTitle: (name: string, chars: number) =>
      `Resume: ${name} (${chars} chars) — click to replace (.md/.txt/.docx/.pdf/.pptx)`,
    resumeEmptyTitle: 'Import my resume (.md/.txt/.docx/.pdf/.pptx)',
    resumeRemoveTitle: 'Remove resume',
    jd: 'JD',
    jdSetTitle: (name: string, chars: number) =>
      `Job description: ${name} (${chars} chars) — click to replace (.md/.txt/.docx/.pdf/.pptx)`,
    jdEmptyTitle: 'Import the job description (.md/.txt/.docx/.pdf/.pptx)',
    ...
    emptyKbHint:
      '\n\nTip: import your resume / the JD with “📄Resume” “📋JD” above (docx/pdf/pptx supported) for answers tailored to you.',
    stop: 'Stop',
    copy: 'Copy',
    copyTitle: 'Copy',
  ...
  knowledge: {
    ...
    importItemReason: {
      ...
      'too-large': 'over 50 MB — never opened',
    },
    importItemChunks: (n: number) => `${n} chunks`,
    importItemSummaries: (n: number) => `${n} section summaries`,
  ...
  settings: {
    ...
    otherSection: 'Other',
    otherHint:
      'The mic toggle and Text/Vision live in the title bar; import the resume/JD per session via “📄Resume” “📋JD” on the prompt card (docx/pdf/pptx supported).',
